...
object ApplicationConfig extends ServicesConfig {
  ...
  def webchatAvailabilityUrl = s"https://online.hmrc.gov.uk/webchatprod/egain/chat/entrypoint/checkEligibility/$webchatEntryPoint"
...
trait FeatureTogglesConfig extends ServicesConfig {
  ...
  val cyApdNewPageEnabled = configuration.getBoolean("tai.feature.cyApdNewPage.enabled").getOrElse(true)
}

...
case class PaySlipAmountViewModel(payslipForm: Form[PayslipForm], payPeriodTitle: String, employer: Employer)
...
object PaySlipAmountViewModel extends EditIncomePayPeriodConstants with DynamicPayPeriodTitle {
  ...
  def apply(payslipForm: Form[PayslipForm],
            ...
            employer: Employer)(implicit message: Messages): PaySlipAmountViewModel = {

...
trait JourneyCacheConstants {
  ...
  val AddEmployment_ReceivedFirstPayKey = "employmentFirstPayReceived"
  ...
  val TrackSuccessfulJourney_UpdateEndEmploymentKey = "updateEndEmployment"
  ...
  val TrackSuccessfulJourney_EstimatedPayKey = "updateEstimatedPay"
  ...
  val UpdateIncome_HowToUpdateKey = "updateIncomeHowToUpdate"
  val UpdateIncome_WorkingHoursKey = "updateIncomeWorkingHours"

  ...
  "Simple Estimated Income Tax View Model" must {
   "return a valid view model for valid input" in {
     ...
     val taxCodeIncome = Seq(
       TaxCodeIncome(EmploymentIncome,Some(1),BigDecimal(39107),"EmploymentIncome","277L","TestName",
     ...
     SimpleEstimatedIncomeTaxViewModel(codingComponents,taxAccountSummary,taxCodeIncome,taxBands) mustBe expectedViewModel

...
class HistoricPayAsYouEarnViewModelSpec extends BaseSpec {
  ...
  "HistoricPayAsYouEarnViewModel" should {
    ...
    "return Nil employments" when {
      ...
      "an employment is supplied but the employment doesn't have an AnnualAccount for the required year" in {
        ...
        val cyMinusThreeAnnualAccount = AnnualAccount(1, cyMinusThreeTaxYear, Available, Nil, Nil)
        val cyMinusOneAnnualAccount = AnnualAccount(1, cyMinusOneTaxYear, Available, Nil, Nil)
  ...
  private val annualAccountWithNoPayments = AnnualAccount(0, cyMinusOneTaxYear, Available, Nil, Nil)
  private val annualAccountWithSinglePayment =
    AnnualAccount(0, cyMinusOneTaxYear, Available, singleAnnualAccountsPayment, Nil)
  private val annualAccountWithMultiplePayments =
    AnnualAccount(0, cyMinusOneTaxYear, Available, multipleAnnualAccountsPayments, Nil)

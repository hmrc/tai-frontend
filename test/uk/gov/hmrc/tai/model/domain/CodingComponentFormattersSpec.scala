  ...
  "taxComponentTypeReads" must {
    "read tax component type correctly" when {
      "given a valid IabdType" in {
        ...
        JsString("BpaReceivedFromSpouseOrCivilPartner").as[TaxComponentType](taxComponentTypeReads) mustBe BpaReceivedFromSpouseOrCivilPartner
        JsString("CommunityInvestmentTaxCredit").as[TaxComponentType](taxComponentTypeReads) mustBe CommunityInvestmentTaxCredit
        JsString("GiftsSharesCharity").as[TaxComponentType](taxComponentTypeReads) mustBe GiftsSharesCharity
        JsString("RetirementAnnuityPayments").as[TaxComponentType](taxComponentTypeReads) mustBe RetirementAnnuityPayments
        ...
        JsString("NonQualifyingRelocationExpenses").as[TaxComponentType](taxComponentTypeReads) mustBe NonQualifyingRelocationExpenses
        ...
        JsString("PaymentsOnEmployeesBehalf").as[TaxComponentType](taxComponentTypeReads) mustBe PaymentsOnEmployeesBehalf
        JsString("PersonalIncidentalExpenses").as[TaxComponentType](taxComponentTypeReads) mustBe PersonalIncidentalExpenses
        JsString("QualifyingRelocationExpenses").as[TaxComponentType](taxComponentTypeReads) mustBe QualifyingRelocationExpenses
        JsString("EmployerProvidedProfessionalSubscription").as[TaxComponentType](taxComponentTypeReads) mustBe EmployerProvidedProfessionalSubscription
        JsString("IncomeTaxPaidButNotDeductedFromDirectorsRemuneration").as[TaxComponentType](taxComponentTypeReads) mustBe IncomeTaxPaidButNotDeductedFromDirectorsRemuneration
        ...
        JsString("ProfessionalSubscriptions").as[TaxComponentType](taxComponentTypeReads) mustBe ProfessionalSubscriptions
        ...
        JsString("ForeignInterestAndOtherSavings").as[TaxComponentType](taxComponentTypeReads) mustBe ForeignInterestAndOtherSavings
        JsString("ForeignPensionsAndOtherIncome").as[TaxComponentType](taxComponentTypeReads) mustBe ForeignPensionsAndOtherIncome
        ...
        JsString("BankOrBuildingSocietyInterest").as[TaxComponentType](taxComponentTypeReads) mustBe BankOrBuildingSocietyInterest
        ...
        JsString("MarriedCouplesAllowanceToWifeMAW").as[TaxComponentType](taxComponentTypeReads) mustBe MarriedCouplesAllowanceToWifeMAW
        ...
        JsString("EnterpriseInvestmentScheme").as[TaxComponentType](taxComponentTypeReads) mustBe EnterpriseInvestmentScheme
        ...
        JsString("MarriedCouplesAllowanceMAE").as[TaxComponentType](taxComponentTypeReads) mustBe MarriedCouplesAllowanceMAE
        JsString("MarriedCouplesAllowanceMCCP").as[TaxComponentType](taxComponentTypeReads) mustBe MarriedCouplesAllowanceMCCP
        JsString("SurplusMarriedCouplesAllowanceToWifeWAE").as[TaxComponentType](taxComponentTypeReads) mustBe SurplusMarriedCouplesAllowanceToWifeWAE
        JsString("MarriedCouplesAllowanceToWifeWMA").as[TaxComponentType](taxComponentTypeReads) mustBe MarriedCouplesAllowanceToWifeWMA
        ...
        JsString("PersonalAllowanceElderlyPAE").as[TaxComponentType](taxComponentTypeReads) mustBe PersonalAllowanceElderlyPAE
        JsString("EmploymentAndSupportAllowance").as[TaxComponentType](taxComponentTypeReads) mustBe EmploymentAndSupportAllowance
        JsString("ChildBenefit").as[TaxComponentType](taxComponentTypeReads) mustBe ChildBenefit
        JsString("MarriageAllowanceTransferred").as[TaxComponentType](taxComponentTypeReads) mustBe MarriageAllowanceTransferred
        JsString("MarriageAllowanceReceived").as[TaxComponentType](taxComponentTypeReads) mustBe MarriageAllowanceReceived
        JsString("DividendTax").as[TaxComponentType](taxComponentTypeReads) mustBe DividendTax

        JsString("UnderPaymentFromPreviousYear").as[TaxComponentType](taxComponentTypeReads) mustBe UnderPaymentFromPreviousYear
        JsString("OutstandingDebt").as[TaxComponentType](taxComponentTypeReads) mustBe OutstandingDebt
        JsString("EstimatedTaxYouOweThisYear").as[TaxComponentType](taxComponentTypeReads) mustBe EstimatedTaxYouOweThisYear
  ...
  "taxCodeIncomeSourceStatusReads" must{
    "read the field correctly" when{
      ...
      "json string is PotentiallyCeased" in{
        JsString("PotentiallyCeased").as[TaxCodeIncomeSourceStatus](taxCodeIncomeSourceStatusReads) mustBe PotentiallyCeased
      }
    ...
    "throw runtime exception" when {
      "provided with unrecognized status" in {
        val ex = the[IllegalArgumentException] thrownBy  JsString("Some Status").as[TaxCodeIncomeSourceStatus](taxCodeIncomeSourceStatusReads)

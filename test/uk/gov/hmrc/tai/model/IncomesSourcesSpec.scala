    ...
    val employmentGen: Gen[Employment] =
      for {
        ...
        Employment(
          ...
          None,
          Seq(AnnualAccount(1, uk.gov.hmrc.tai.model.TaxYear(), realTimeStatus, Nil, Nil)),
          "DIST1",
          "PAYE1",
          1,
          None,
  ...
  def rtiUnAvailableIncomeSource: Gen[Seq[TaxedIncome]] = {
    val employment =
      Employment(
        ...
        new LocalDate(2017, 3, 1),
        None,
        Seq(AnnualAccount(1, uk.gov.hmrc.tai.model.TaxYear(), TemporarilyUnavailable, Nil, Nil)),
        "DIST1",
        "PAYE1",
        1,
        None,

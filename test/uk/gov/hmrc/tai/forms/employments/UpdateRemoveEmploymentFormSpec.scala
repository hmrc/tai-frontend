...
class UpdateRemoveEmploymentFormSpec extends PlaySpec with OneAppPerSuite with I18nSupport with FormValuesConstants {
  ...
  private val form = UpdateRemoveEmploymentForm.form
}

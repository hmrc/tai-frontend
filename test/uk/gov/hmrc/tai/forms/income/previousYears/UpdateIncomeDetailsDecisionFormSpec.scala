...
class UpdateIncomeDetailsDecisionFormSpec extends BaseSpec with FormValuesConstants {
  ...
  val choice = UpdateIncomeDetailsDecisionForm.UpdateIncomeChoice

  private val form = UpdateIncomeDetailsDecisionForm.form
}

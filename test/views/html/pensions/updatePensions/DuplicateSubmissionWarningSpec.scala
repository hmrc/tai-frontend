...
//
//      val errorView = views.html.includes.duplicateSubmissionWarning(invalidatedForm,new PensionDuplicateSubmissionWarningViewModel(pensionName),pensionId)
...
//  }
//
//  override def view: Html = views.html.includes.duplicateSubmissionWarning(duplicateSubmissionWarningForm,new PensionDuplicateSubmissionWarningViewModel(pensionName),pensionId)
//}
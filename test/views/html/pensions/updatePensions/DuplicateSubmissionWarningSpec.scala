...
class DuplicateSubmissionWarningSpec extends TaiViewSpec with FormValuesConstants {
  ...
  "duplicateSubmissionWarning" must {
    ...
    "display an error for invalid choice" in {
      ...
      val errorView = views.html.pensions.update.duplicateSubmissionWarning(invalidatedForm,pensionName,pensionId)
  ...
  override def view: Html = views.html.pensions.update.duplicateSubmissionWarning(duplicateSubmissionWarningForm,pensionName,pensionId)
}
...
class WhatDoYouWantToTellUsSpec extends TaiViewSpec {
  ...
  override def view: Html = views.html.pensions.update.whatDoYouWantToTellUs(pensionName,UpdateEmploymentDetailsForm.form)

  "whatDoYouWantToTellUs" must {
    behave like pageWithTitle(Messages("tai.updatePension.whatDoYouWantToTellUs.title"))
    behave like pageWithCombinedHeader(Messages("tai.updatePension.whatDoYouWantToTellUs.preHeading"),
      Messages("tai.updatePension.whatDoYouWantToTellUs.heading"))

...
class UpdateIncomeDetailsConfirmationViewSpec extends TaiViewSpec {
  private val UpdateIncomeDetailsConfirmation = inject[UpdateIncomeDetailsConfirmationView]

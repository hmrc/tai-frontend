...
//      implicit val fakeRequest = FakeRequest("POST", "").withFormUrlEncodedBody("totalSalary" -> "Ã‚Â£Ã‚Â£12,000")
//
//      val paySlipForm = PayslipForm.createForm().bindFromRequest()
//      paySlipForm.hasErrors shouldBe true
//    }
...
//      implicit val fakeRequest = FakeRequest("POST", "").withFormUrlEncodedBody("totalSalary" -> "Ã‚Â£12,000")
//
//      val payslipForm = PayslipForm.createForm().bindFromRequest()
...
//      ScalaFutures.whenReady(session) {sessionData =>
//
//        val result = testController.processPayslipAmount(Nino(s"${testTaxSummary.nino}A"), 14, "Employer Name")(RequestBuilder.buildFakeRequestWithAuth("POST").withFormUrlEncodedBody("totalSalary" -> "Ã‚Â£3,000"), UserBuilder.apply(), sessionData)
//
//        status(result) shouldBe 303
//
//        val redirectUrl = redirectLocation(result) match {
...
//      val result = testController.handlePayslipAmount()(RequestBuilder.buildFakeRequestWithAuth("POST").withFormUrlEncodedBody("totalSalary" -> "Ã‚Â£3,000"))
//
//      status(result) shouldBe 303
//
//      val redirectUrl = redirectLocation(result) match {
...
//      ScalaFutures.whenReady(session) {sessionData =>
//
//        val result = testController.processTaxablePayslipAmount(Nino(s"${testTaxSummary.nino}A"), 14, "Employer Name")(RequestBuilder.buildFakeRequestWithAuth("POST").withFormUrlEncodedBody("taxablePay" -> "Ã‚Â£3,000"), UserBuilder.apply(),sessionData)
//
//        status(result) shouldBe 303
//
//        val redirectUrl = redirectLocation(result) match {
...
//      val testController = buildIncomeUpdateCalculatorController(testTaxSummary, mockIncomeCalculation = Some(IncomeCalculation(incomeId = None,
//        payslipForm = Some(PayslipForm.create(PayslipForm(totalSalary = Some("3000"))).get))))
//      val result = testController.handleTaxablePayslipAmount()(RequestBuilder.buildFakeRequestWithAuth("POST").withFormUrlEncodedBody("taxablePay" -> "Ã‚Â£3,000"))
//
//      status(result) shouldBe 303
//
//      val redirectUrl = redirectLocation(result) match {
...
//      val testTaxSummary = TaiData.getBasicRateTaxSummary
//      val testController = buildIncomeUpdateCalculatorController(testTaxSummary, mockIncomeCalculation = Some(IncomeCalculation(incomeId = None)))
//      val result = testController.handleBonusOvertimeAmount()(RequestBuilder.buildFakeRequestWithAuth("POST").withFormUrlEncodedBody("amount" -> "Ã‚Â£3,000"))
//
//      status(result) shouldBe 303
//
//      val redirectUrl = redirectLocation(result) match {
...
//
//      payBeforeTax shouldBe "Ã‚Â£100"
//      amountPayTaxOn shouldBe "Ã‚Â£80"
//    }
//  }
//

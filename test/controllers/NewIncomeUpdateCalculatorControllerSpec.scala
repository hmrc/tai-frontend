...
//
//class NewIncomeUpdateCalculatorNewControllerSpec extends PlaySpec with FakeTaiPlayApplication with MockitoSugar with JourneyCacheConstants {
//
...
//
//        status(result) mustBe SEE_OTHER
//        redirectLocation(result).get mustBe routes.IncomeUpdateCalculatorNewController.workingHoursPage().url
//      }
//
...
//
//        status(result) mustBe SEE_OTHER
//        redirectLocation(result).get mustBe routes.IncomeUpdateCalculatorNewController.payPeriodPage().url
//      }
//
...
//
//        status(result) mustBe SEE_OTHER
//        redirectLocation(result).get mustBe routes.IncomeUpdateCalculatorNewController.calcUnavailablePage().url
//      }
//
//      "user submits no data to the page" in {
//        val sut = createSut
...
//
//  class SUT extends IncomeUpdateCalculatorNewController {

...
class YourIncomeCalculationPageVMSpec
  ...
  "YourIncomeCalculationPageVM return employment status based on income id" must {
    ...
    val assertResult = (incomeId: Int, employmentStatus: Int, endDate: Option[LocalDate], taxSummary: TaxSummaryDetails) => {
      ...
      res.employmentStatus mustBe Some(employmentStatus)
      res.endDate mustBe endDate
    }

...
class YourIncomeCalculationControllerNewSpec extends PlaySpec
  ...
  "Your Income Calculation" must {
    "return rti details page" when {
      "rti details are present" in {
        ...
        doc.title() mustBe Messages("tai.income.calculation.TaxableIncomeDetails", employment.name)
  ...
  class SUT extends YourIncomeCalculationControllerNew {
